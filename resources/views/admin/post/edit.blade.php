...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="" action="{{route('admin.post.update', $post->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-group w-25">
                          ...
                          <div class="mb-4">
                              <div class="75">
                                  <img src="{{asset('storage/uploads/'.$post->preview_image)}}" alt="preview_image" class="w-50">
                              </div>
                          </div>
                        ...
                        <div class="form-group w-25">
                           ...
                           <div class="mb-4">
                               <div class="">
                                   <img src="{{asset('storage/uploads/'.$post->main_image) }}" alt="main_image" class="w-50">
                               </div>
                           </div>
                            <div class="input-group">
                                <div class="custom-file">
